...
class PolyglotBook {
   private:
    ...
    // Piece/Square: [0:768)
    // Castle Rights: [768:772)
    // En Passant File: [772:780)
    // Side to Move: [780:781)
    static constexpr std::array<uint64_t, 781> POLYGLOT_RANDOM = {
    ...
    inline constexpr int pgFileOf(Square sq) {
        return fileOf(sq);
    }
